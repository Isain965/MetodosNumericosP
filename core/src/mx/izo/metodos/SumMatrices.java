...
public class SumMatrices implements Screen {
    ...
    public SumMatrices(Plataforma plataforma) {
    ...
    public void multiplicacion() {
        ...
        if(m1final) {
            ...
            for (int x=0; x < m1.length; x++) {
                for (int y = 0; y < m1[x].length; y++) {
                    System.out.print(String.valueOf(m1[x][y])+" ");
                }
                System.out.println();
            }
            m1final=false;
        ...
        if(m2final) {
            ...
            for (int x=0; x < m2.length; x++) {
                for (int y = 0; y < m2[x].length; y++) {
                    System.out.print(String.valueOf(m2[x][y])+" ");
                }
                System.out.println();
            }
            m2final=false;
        ...
        if(datosCompletados1&&datosCompletados2){
            sumaM=producto(m1,m2);
            //Imprimir matriz
            for (int x=0; x < sumaM.length; x++) {
                for (int y = 0; y < sumaM[x].length; y++) {
                    System.out.print(String.valueOf(sumaM[x][y])+ " ");
                }
                System.out.println();
            }
    ...
    private static int[][] producto(int m1[][], int m2[][]){
        Gdx.app.log("Haciendo la suma","holiz");
